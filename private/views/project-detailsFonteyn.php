<?php $this->layout("layoutProjectsDetailsFonteyn") ?>
...
<section id="details">
  <div class="gridDetails">
    <div class="detailPicFon">
      <img src="<?php echo site_url("/img/Fonteyn.png") ?>" alt="foto project">
    </div>
    <div class="detailText">
      ...
      <div class="jezelf">
        <img src="<?php echo site_url("/img/Stepinin_Fonteyn.jpg") ?>" alt="foto van jezelf">
        <p>Hallo, ik ben één van de vormgevers <br> van <span class="paars">Stepinin.</span></p>
      </div>
