<?php $this->layout("layoutProjectsDetailsRosanne") ?>
...
<section id="details">
  <div class="gridDetails">
    <div class="detailPicRos">
      <img src="<?php echo site_url("/img/rosanne.png") ?>" alt="project foto">
    </div>
    <div class="detailText">
      <h2>Brand Identity - Hallo Rust</h2>
      <p>Voor het startup bedrijf Hallo Rust heb ik een huisstijl mogen ontwerpen. Door middel van een geleide meditatie wil Hallo Rust stress bij jongeren verhelpen. De kernwaardes van het bedrijf zijn ontdekken, samen, verbinden, puur en authentiek. Ik ben onderzoek gaan doen naar de doelgroep van het bedrijf, wat Hallo Rust is, wat haar doel is en hoe zij die wil bereiken. Ik wil de rust die Hallo Rust over wil brengen naar jongeren, ook in de huisstijl erg naar boven laten komen. Een lotusbloem groeit uit moerasachtige wateren, er blijft nooit modder aan de blaadjes hangen. Door dit zelfreinigende vermogen en de puurheid van de bloem, vond ik dit erg geschikt als logo. De bloem heb ik op een minimalistische manier weergegeven doormiddel van stromende golven. Voor het visitekaartje en het briefpapier wilde ik deze rust, met veel wit en open ruimtes, doorzetten. Zie hiernaast het resultaat.</p>
      <div class="jezelf">
        <img src="<?php echo site_url("/img/Stepinin_Rosanne.jpg") ?>" alt="foto van jezelf">
        <p>Hoi leuk je te ontmoeten! Ik ben Rosanne de Boer, <br>een van de vormgevers van Stepinin. </p>
      </div>
