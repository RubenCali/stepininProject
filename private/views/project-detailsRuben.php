<?php $this->layout("layoutProjectsDetailsRuben") ?>
  ...
  <div class="gridDetails">
    <div class="detailPic">
      <video width="788" controls>
        <source src="<?php echo site_url("/vid/rubenWeb.mp4") ?>" type="video/mp4">
        <source src="<?php echo site_url("/vid/rubenWeb.mp4") ?>" type="video/ogg">
        Your browser does not support HTML video.
      </video> 
    </div>
    <div class="detailText">
      <h2>RUBEN CALI - PORTFOLIO</h2>
      ...
      <div class="jezelf">
        <img src="<?php echo site_url("/img/Stepinin_Ruben.jpg") ?>" alt="foto van jezelf">
        <p>Hallo, ik ben Ruben Cali één van de developers <br> van <span class="paars">Stepinin.</span></p>
        <!-- <a href="https://www.rubencali.nl/" target="_blank">Zie portfolio</a> -->
      </div>
